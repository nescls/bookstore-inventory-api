...
- [ ] Set exported Postman variables or environment to the real public URL; run the collection against the deployed API and verify persistence and EUR calculations.
